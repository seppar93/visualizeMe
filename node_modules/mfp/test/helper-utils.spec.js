...
describe('mfpUrl', function(){
  ...
  it('should construct a proper url when given a username and date', function(){
    (mfpUrl('azey47', '2014-07-08', '2014-07-08')).should.equal('https://www.myfitnesspal.com/reports/printable_diary/azey47?from=2014-07-08&to=2014-07-08');
  });

  it('should construct a proper url when only given a username', function(){
    (mfpUrl('azey47')).should.equal('https://www.myfitnesspal.com/reports/printable_diary/azey47');
  });
