...
var ctx = document.getElementById("---"); // <-- div for area hold weight line graph goes in here
var caloriesChart = new Chart(ctx, {
    type: 'line',//type of chart
    data: {
      labels : dateToGraph,  //variable for dates
      datasets: [ {
        label: "Weight",//name of chart
        backgroundColor: 'rgba(rgb(0,250,154,0.4)',
        borderColor: 'rgba(rgb(0,250,154,1)',
        data: ,     //<--the weight variable pulled from the JSON loop
    }]
  },
});